...
class MiUnlockLoginActivity : AppCompatActivity() {
    ...
    private val initialUrl = "https://account.xiaomi.com/pass/serviceLogin?sid=unlockApi&json=false&passive=true&hidden=false&_snsDefault=google&checkSafePhone=true"
